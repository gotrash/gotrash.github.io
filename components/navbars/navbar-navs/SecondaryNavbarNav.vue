<template>
  <b-navbar-nav>
    ...
    <template v-else>
      <b-nav-item active-class="active" exact :label="$t('NAV__USER')" :to="{ name: 'admin-user' }">
        <fa-icon icon="user" />
      </b-nav-item>
      <b-nav-item active-class="active" :label="$t('NAV__BUSINESS_PROFILE')" :to="{ name: 'business' }">
        <fa-icon icon="building" />
      </b-nav-item>
      <b-nav-item active-class="active" exact :label="$t('NAV__SETTINGS')" :to="{ name: 'admin' }">
        <fa-icon icon="cog" />
      </b-nav-item>
      <b-nav-item active-class="active" :label="$t('NAV__USERS_DASHBOARD')" :to="{ name: 'users' }">
        <fa-icon icon="users" />
      </b-nav-item>
      <b-nav-item active-class="active" :label="$t('NAV__JOBS')" :to="{ name: 'jobs' }">
        <fa-icon icon="tasks" />
      </b-nav-item>
      <b-nav-item
        :title="$t('NAV__LOGOUT')"
