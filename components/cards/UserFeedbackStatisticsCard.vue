    ...
    <b-card-body class="p-0">
      <div class="d-flex">
        <div class="d-none d-md-flex flex-column border-right">
          <div
            class="py-3 px-3 px-xl-4 border-bottom text-center"
            title="The amount of jobs you have left feedback for"
          >
            <div class="mb-3">
          ...
          <b-row>
            <b-col cols="12" class="py-2">
              <b-table-simple class="text-center" small caption-top responsive>
                <caption class="mb-2">
                  Statistics for the feedback you have left over time.
                </caption>
                <b-thead>
                  <b-tr>
                    <b-th></b-th>
                ...
                <b-tbody>
                  <b-tr class="lh-lg">
                    ...
                    <b-td
                      ><small>{{ statistics.three.positive }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.six.positive }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.twelve.positive }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.total.positive }}</small></b-td
                    >
                  </b-tr>
                  <b-tr class="lh-lg">
                    <b-td class="text-start"><small>Negative</small></b-td>
                    <b-td
                      ><small>{{ statistics.three.negative }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.six.negative }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.twelve.negative }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.total.negative }}</small></b-td
                    >
                  </b-tr>
                  <b-tr class="lh-lg">
                    <b-td class="text-start"><small>Total</small></b-td>
                    <b-td
                      ><small>{{ statistics.three.total }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.six.total }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.twelve.total }}</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.total.total }}</small></b-td
                    >
                  </b-tr>
                  <b-tr class="lh-lg">
                    <b-td class="text-start"><small>Ratio</small></b-td>
                    <b-td
                      ><small>{{ statistics.three.ratioPercent }}%</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.six.ratioPercent }}%</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.twelve.ratioPercent }}%</small></b-td
                    >
                    <b-td
                      ><small>{{ statistics.total.ratioPercent }}%</small></b-td
                    >
                  </b-tr>
                </b-tbody>
              </b-table-simple>
