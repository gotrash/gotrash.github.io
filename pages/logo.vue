    ...
    <b-row>
      <b-col cols="12">
        <h1 ref="logo-element" class="position-relative">
          Go<span ref="little-t" class="to-hide">t </span
          ><span ref="movable-text" class="to-move">Trash<span ref="question-mark" class="to-hide">?</span></span>
        </h1>
      </b-col>
    </b-row>
  </b-container>
  ...
  export default {
    ...
    methods: {
      init() {
        ...
        console.log("Logo Width: %s", logoWidth);
        console.log("Little T Offset: %s", littleTOffset);
        console.log("Question Mark Offset: %s", questionMarkOffset);
        console.log("Moveable Text Offset: %s", movableTextOffset);
