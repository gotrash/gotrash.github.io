<template>
  <div>
    <div class="d-flex align-items-center pb-10 position-relative" :style="{
      ...
      <b-container fluid>
        <b-row>
          <b-col cols="12" sm="6" offset-sm="3" lg="4" offset-lg="4">
            <b-card class="rounded-lg" body-bg-variant="gray-300" footer-bg-variant="light" header-bg-variant="light"
