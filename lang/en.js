export default {
  ...
  // Page Summaries
  PAGE_SUMMARY__ADMIN__BIDS: "This is where all of the bids in GoTrash can be managed.",
  PAGE_SUMMARY__ADMIN__CONTINENTS: "This is where the data for continents is managed for the global GoTrash system.",
  PAGE_SUMMARY__ADMIN__COUNTRIES: "This is where the system-wide country data and availability is managed.",
  PAGE_SUMMARY__ADMIN__FEEDBACK: "This is where you can access ALL of the invoices in GoTrash.",
  PAGE_SUMMARY__ADMIN__INVOICES: "This is all of the customer invoices in GoTrash.",
  PAGE_SUMMARY__ADMIN__JOBS: "These are all of the jobs that customers have submitted to GoTrash.",
  PAGE_SUMMARY__ADMIN__POSTCODES: "This is where we can manage the postcode availability within GoTrash.",
  PAGE_SUMMARY__ADMIN__DATABASE:
    "This is where you can find all of the database change logs and associated database functionality.",
  PAGE_SUMMARY__MAP_TEST_PAGE: "This is a page for developing and debugging map-related functionality.",
  ...
  // Page Titles
  PAGE_TITLE__ADMIN__BIDS: "Bids",
  PAGE_TITLE__ADMIN__CONTINENTS: "Continents",
  PAGE_TITLE__ADMIN__COUNTRIES: "Countries",
  PAGE_TITLE__ADMIN__DATABASE: "Database",
  PAGE_TITLE__ADMIN__FEEDBACK: "Feedback",
  PAGE_TITLE__ADMIN__INVOICES: "Invoices",
  PAGE_TITLE__ADMIN__JOBS: "Jobs",
  PAGE_TITLE__FEEDBACK: "Feedback",
  PAGE_TITLE__HOME: "Welcome to GoTrash",
  PAGE_TITLE__LOGIN: "Login",
  PAGE_TITLE__MAP_TEST_PAGE: "Map Test Page",
  ...
  PAGE_TITLE__USER_ADDRESSES__EDIT_ADDRESS: "Edit Address",
  ...
  "BIDS.LABEL.ACCEPTED_AT": "Accepted At",
  "BIDS.LABEL.ID": "ID",
  "BIDS.LABEL.JOB": "Job",
  ...
  "GENERAL.MESSAGE.CANCELLING": "Cancelling | Cancelling...",
  "GENERAL.MESSAGE.RESETTING": "Resetting | Resetting...",
  "GENERAL.MESSAGE.SUBMITTING": "Submitting | Submitting...",
  ...
  "JOBS.LABEL.DETAILED_DESCRIPTION": "Detailed Description",
  "JOBS.LABEL.END_DATE_REQUIRED": "End Date Required",
  "JOBS.LABEL.ID": "ID",
  "JOBS.LABEL.IS_BUSINESS": "Business",
  "JOBS.LABEL.IS_RECYCLABLE": "Recyclable",
  "JOBS.LABEL.IS_EASY_ACCESS": "Easy Access",
  "JOBS.LABEL.IS_BUILDER_WASTE": "Builder Waste",
  "JOBS.LABEL.IMAGES": "Images",
  "JOBS.LABEL.LOAD_SIZE": "Load Size",
  "JOBS.LABEL.JOB_TYPE": "Job Type",
  "JOBS.LABEL.PUBLISHED_AT": "Published At",
  "JOBS.LABEL.SUMMARY": "Summary",
  ...
  "JOBS.INVALID.SUMMARY_TOO_SHORT": "The job summary must be at least 10 characters.",
  "JOBS.INVALID.SUMMARY_TOO_LONG": "The job summary must be less than 100 characters.",
  "JOBS.INVALID.IMAGES_REQUIRED": "You must provide at least one image.",
  "JOBS.INVALID.IS_BUILDER_WASTE_REQUIRED": "Please tell us whether this is builder waste or not.",
  "JOBS.INVALID.IS_BUSINESS_REQUIRED": "We need to know whether this waste currently belongs to a business.",
  "JOBS.INVALID.IS_EASY_ACCESS_REQUIRED": "Let us know whether the waste is easy to access.",
  "JOBS.INVALID.IS_RECYCLABLE_REQUIRED": "You must tell us whether the waste is recyclable.",
  "JOBS.INVALID.IS_REUSABLE_REQUIRED": "You must tell us whether the waste is reusable.",
  "JOBS.INVALID.LOAD_SIZE_REQUIRED": "Our providers need to know the size of the load.",
  // Job Types
  ...
  "USER_ADDRESSES.LABEL.ADDRESS_LINE_ONE": "Address Line One",
  "USER_ADDRESSES.LABEL.ADDRESS_LINE_TWO": "Address Line Two",
  "USER_ADDRESSES.LABEL.ADDRESS": "Address",
  "USER_ADDRESSES.LABEL.COUNTRY": "Country",
  "USER_ADDRESSES.LABEL.COUNTY": "County",
  "USER_ADDRESSES.LABEL.DELETE_ADDRESS": "Delete Address",
  "USER_ADDRESSES.LABEL.FIND_ADDRESS": "Find Address",
  "USER_ADDRESSES.LABEL.GOOGLE_PLACE_ID": "Google Place ID",
  "USER_ADDRESSES.LABEL.LABEL": "Label",
  "USER_ADDRESSES.LABEL.LATITUDE": "Latitude",
  "USER_ADDRESSES.LABEL.LONGITUDE": "Longitude",
  "USER_ADDRESSES.LABEL.MAP": "Map",
  "USER_ADDRESSES.LABEL.POSTCODE": "Postcode",
  "USER_ADDRESSES.LABEL.TOWN": "Town",
  "USER_ADDRESSES.LABEL.VIEW_ADDRESS": "View Address",
  "USER_ADDRESSES.MESSAGE.DELETING_ADDRESS": "Deleting Address",
  "USER_ADDRESSES.MESSAGE.LOADING_ADDRESS": "Loading Address | Loading Addresses",
  ...
  "USER_ADDRESSES.FIELD_TEXT.LABEL": "This field is simply to make it easier for you to identify addresses later.",
  // Verification Tokens
  ...
  // Load Sizes
  "LOAD_SIZES.LABEL.SMALL": "Small",
  "LOAD_SIZES.LABEL.MEDIUM": "Medium",
  "LOAD_SIZES.LABEL.LARGE": "Large",
  "LOAD_SIZES.MESSAGE.PLACEHOLDER": "Please select a load size"
};
